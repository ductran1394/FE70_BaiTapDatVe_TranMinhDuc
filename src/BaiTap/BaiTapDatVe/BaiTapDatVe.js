...
export default class BaiTapDatVe extends Component {
  ...
  renderHangGhe = () => {
    return dataJson.map((hangGhe, index) => {
  ...
  render() {
    return (
      <div style={{ position: "fixed", width: "100%", height: "100%", backgroundImage: "url(./img/BaiTapDatVe/bgmovie.jpg)", backgroundRepeat: "no-repeat", backgroundSize: "100%" }}>
        <div style={{ backgroundColor: "rgba(0,0,0,0.8", position: "fixed", width: "100%", height: "100%" }}>        </div>
        <div className='container'>
          <div className='row'>
            <div className='col-8'>
              <h2 className='text-warning'>Vui lòng chọn vé</h2>
              <div className='screen text-center mt-2'>Màn hình</div>
              {this.renderHangGhe()}
            </div>
            <div className='col-4'>
              <h2 className='text-light mt-5 text-center'>Thông tin chọn ghế</h2>
              <ThongTinDatGhe />
            </div>
          </div>
